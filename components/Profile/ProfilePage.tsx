...
import { User, AttendanceEntry, DevelopmentPlanItem, TrainingApplication, UserAchievement, UserDisciplinaryAction, KanbanTask, PerformanceReview, SalaryHistoryEntry } from '../../types';
