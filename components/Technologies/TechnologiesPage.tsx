...
const TechnologiesPage: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // FIX: Property 'warehouseItemId' does not exist on type 'unknown'.
      // Fix: Explicitly type the initial value of the reduce function. This helps TypeScript's inference.
