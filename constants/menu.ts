...
import {
    ...
    AwardIcon, ListBulletIcon, DocumentChartBarIcon as ChartBarIcon, HeartIcon, FlagIcon, ArrowPathIcon
...
const ensureCoreItems = (config: MobileNavItemConfig[]): MobileNavItemConfig[] => {
    const corePaths = [
        ROUTE_PATHS.DASHBOARD, ROUTE_PATHS.ORDERS, ROUTE_PATHS.DOCUMENTS, ROUTE_PATHS.PRODUCTION,
        ROUTE_PATHS.WAREHOUSE, ROUTE_PATHS.KANBAN_HOME, ROUTE_PATHS.KNOWLEDGE_BASE,
    ];
    let result = [...config];
